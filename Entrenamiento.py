...
from keras_preprocessing.image import ImageDataGenerator  #Nos ayuda a preprocesar las imagenes que le entreguemos al modelo
...
cnn.compile(loss = 'categorical_crossentropy', optimizer= 'lr', metrics=['accuracy'])
